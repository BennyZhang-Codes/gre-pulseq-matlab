clc; clear; close all;
%% Create a 3D GRE sequence with multiple TEs and separate acquisitions for each TE (i.e. single echo per TR).
...
seq.plot('Label', 'LIN,PAR,ECO,REP', 'timeRange', [0, 7*Actual.TR]);
